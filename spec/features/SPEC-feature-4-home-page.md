...
Pantalla principal con: progreso total del álbum (X/992) con barra visual, contador de repetidas, lista de los 12 grupos del Mundial (A–L) + secciones especiales como entry points para navegar a equipos.

## Criterio de done

- [ ] Contador "X de 992" con barra de progreso (porcentaje calculado)
...
- El total del álbum es **992** — todos los espacios físicos del álbum, incluyendo las 12 de Coca-Cola que tienen su propio espacio dedicado. El progreso es uno solo y se busca llegar a `992/992` para tener el álbum lleno.
